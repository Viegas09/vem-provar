...
export default function PartnerOnboarding() {
      ...
      <div style={{ fontFamily: FONT, background: C.white, minHeight: "100vh" }}>
        ...
        <section className="vp-wrap" style={{ padding: "60px 24px", textAlign: "center", maxWidth: 420 }}>
          ...
          <p style={{ marginTop: 16, fontSize: 14 }}>
            Já tem conta? <Link to="/parceiro/entrar" style={{ color: C.orange, fontWeight: 600, textDecoration: "none" }}>Entrar</Link>
          </p>
        </section>
      </div>
    );
  ...
  async function handleSubmit() {
    ...
    try {
      ...
      navigate("/parceiro/painel", { state: { justCreated: true, restaurantId: restaurant.id } });
    } catch (err) {
