...
export default function SignUp() {
  ...
  return (
    <AuthLayout title="Falta pouco pra provar algo novo!" subtitle="Crie sua conta e descubra os melhores restaurantes de Itapecerica da Serra.">
      <h2 style={{ fontSize: 22, fontWeight: 700, margin: "0 0 22px" }}>Criar conta</h2>
      <SocialButtons />
