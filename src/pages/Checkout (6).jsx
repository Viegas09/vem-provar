  ...
  return (
    <div style={{ fontFamily: FONT, background: C.white, color: C.black, minHeight: "100vh" }}>
      ...
      <form onSubmit={handleConfirm} className="vp-wrap" style={{ padding: "32px 24px 32px", maxWidth: 640 }}>
        ...
        <button type="submit" disabled={submitting || restaurant?.is_open === false || (scheduleMode === "later" && !scheduledFor)}
          style={{ width: "100%", background: submitting || restaurant?.is_open === false || (scheduleMode === "later" && !scheduledFor) ? C.gray : C.orange, color: "#fff", border: "none",
