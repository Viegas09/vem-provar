...
export default function DriverSignUp() {
  ...
  return (
    <AuthLayout title="Faça suas entregas com a gente" subtitle="Crie sua conta de entregador, no seu horário, e receba por cada corrida.">
      <h2 style={{ fontSize: 22, fontWeight: 700, margin: "0 0 22px" }}>Criar conta de entregador</h2>
      ...
      <p style={{ fontSize: 14, color: C.grayText, marginTop: 20, textAlign: "center" }}>
        Já tem conta de entregador?{" "}
        <Link to="/entregador/entrar" style={{ color: C.orange, fontWeight: 600, textDecoration: "none" }}>Entrar</Link>
      </p>
    </AuthLayout>
  );
}
